...
|---|---|---|---|---|
| **Baseline** | DRAW | 40 | 39033 | Plná heuristika (`perfect_endgame_heuristic`) + LossOfPiece pruning |
| **Pruning_None** | DRAW | 40 | 42897 | Plná heuristika bez jakéhokoliv prořezávání (kromě $\alpha$-$\beta$) |
| **Pruning_Retreat** | DRAW | 40 | 41525 | Plná heuristika s agresivním prořezáváním při ústupu |
| **No_Material** | DRAW | 40 | 39033 | Bez materiálové složky (pouze poziční hodnocení) |
| **No_Cornering** | DRAW | 40 | 40894 | Bez bonusu za vytlačení soupeře z centra |
| **No_Coordination** | DRAW | 40 | 36771 | Bez bonusu za koordinaci králů |
| **No_Mobility** | DRAW | 40 | 37694 | Bez hodnocení mobility soupeře |
| **No_RetreatPenalty** | DRAW | 40 | 35750 | Bez penalizace za zbytečný ústup |
| **No_Net** | **WHITE** | **9** | **7435** | **Bez diagonální sítě (Net Formation)** |
| **No_Attack** | DRAW | 40 | 38113 | Bez bonusu za přímé sousedství (útok) |
| **No_CornerControl** | DRAW | 40 | 41828 | Bez bonusu za kontrolu dvojitého rohu |
...
1.  **Vliv „Net Formation“ ($V_{\text{net}}$):**
    ...
    *   To naznačuje, že v této specifické koncovce (2v1 na malé desce) snaha o udržení rigidní diagonální formace („Net“) **bránila** králům v efektivním útoku a uzavření soupeře.
...
3.  **Význam ostatních komponent:**
    *   Ostatní ablace (No_Cornering, No_Mobility atd.) vedly ke stejnému výsledku jako Baseline (remíza v limitu 40 tahů), což naznačuje, že v přítomnosti problematické $V_{\text{net}}$ složky neměly samy o sobě rozhodující vliv na prolomení remízy.
